  ...
  //Récupération de l'article par ID + accès à ses données
  getArticle();
          ...
          if (localStorage.getItem("cart")) {
              ...
              const resultFind = productCart.find(
                  ...
                  //Si le produit commandé n'est pas dans le panier
                      ...
                      let altImgKanap = img.alt;
                      let priceKanap = document.querySelector("#price").textContent;
                      
                      console.log(img);
                      console.log(idKanap, nameKanap, colorKanap, qtyKanap, imgKanap, altImgKanap, priceKanap);
